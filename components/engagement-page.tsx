          ...
          <div className="text-center space-y-6 mb-16">
            ...
            <div className="max-w-2xl mx-auto space-y-6 mt-8">
              <div className="bg-card/50 backdrop-blur-sm border border-accent/20 rounded-2xl p-8 md:p-10 shadow-xl">
                <p className="text-3xl md:text-4xl font-serif text-accent mb-3">SWISS INN Pyramids Golf Resort</p>
                <p className="text-xl md:text-2xl text-muted-foreground mb-6">6th October, Cairo</p>

                {/* Date, Time, and Map in Grid */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <span className="text-lg text-foreground">March 31, 2026</span>
                  </div>
                  <div className="flex items-center justify-center gap-3">
                    <svg className="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                    ...
                    <span className="text-lg text-foreground">3:00 PM</span>
                  </div>
                </div>

                {/* Map Image */}
                <div className="w-full rounded-xl overflow-hidden border border-accent/20 shadow-lg">
                  <Image
                    src="/map-venue.png"
