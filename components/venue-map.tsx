...
export default function VenueMap() {
  ...
  const staticMapUrl = "/venue-map.PNG"
  
  // Google Maps URL for SWISS INN Pyramids Golf Resort
  const googleMapsUrl = "https://maps.app.goo.gl/SEiXKiZhCJgNr6Vd8?g_st=iw"
        ...
        <div className="relative group">
          ...
          <div className="mt-6 text-center px-4">
            <h3 className="text-xl sm:text-2xl font-serif font-medium text-foreground mb-2">
              {isRTL ? 'فندق سويس إن بيراميدز جولف ريزورت' : 'SWISS INN Pyramids Golf Resort'}
            </h3>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 text-xs sm:text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                ...
                <span>{isRTL ? 'السادس من أكتوبر، القاهرة' : '6th October, Cairo'}</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
